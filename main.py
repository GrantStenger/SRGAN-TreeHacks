...
def train():
    ...
    hr_test = []
    lr_test = []
    for img in train_hr_img_list:
        hr_train.append(load_img(config.TRAIN.hr_img_path + "/" + img, (480, 852)))
    for img in train_lr_img_list:
        lr_train.append(load_img(config.TRAIN.lr_img_path + "/" + img, (240, 426)))
    for img in valid_hr_img_list:
        hr_test.append(load_img(config.VALID.hr_img_path + "/" + img, (480, 852)))
    for img in valid_lr_img_list:
        lr_test.append(load_img(config.VALID.lr_img_path + "/" + img, (240, 426)))
